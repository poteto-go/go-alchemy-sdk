...
var expectedTransactionReceipts = `
{
	"receipts": [
		{
			"blockHash": "0xe7212a92cfb9b06addc80dec2a0dfae9ea94fd344efeb157c41e12994fcad60a",
...
func Test_GetTransactionReceipts(t *testing.T) {
	...
	t.Run("normal case: ", func(t *testing.T) {
		...
		t.Run("call alchemy_getTransactionReceipts & return result, blockHash pattern", func(t *testing.T) {
			...
			// Act
			res, err := ether.GetTransactionReceipts(txReceiptsArg)
		...
		t.Run("call alchemy_getTransactionReceipts & return result, blockNumber pattern", func(t *testing.T) {
			patches := gomonkey.NewPatches()
			defer patches.Reset()
